...
@section('content')
    <main class="w-full p-8 mx-auto my-8">
        <h1 class="text-2xl font-bold text-center">Actualizar Blog</h1>
        ...
        <form class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8 mt-6">
            <fieldset class="mb-6">
                ...
                <input type="text" id="titulo" name="blog[titulo]" placeholder="Titulo Blog"
                    ...
                    value="{{ $data['anuncioSeleccionado']['titulo'] }}">
                ...
                <textarea type="text" id="texto" name="blog[texto]" placeholder="Contenido del Blog"
                    class="w-full p-3 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">{{ $data['anuncioSeleccionado']['titulo'] }}</textarea>
            </fieldset>
